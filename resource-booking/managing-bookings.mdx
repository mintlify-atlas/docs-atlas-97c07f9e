...
<Steps>
  ...
  <Step title="Assign a combination or leave it to Auto Assign">
    ...
    To override this, uncheck **Auto assigned** and manually select a **Resources Combination**. Only combinations linked to the selected booking type appear in the dropdown.
  </Step>
  <Step title="Save">

...
|---|---|---|
| `calendar_export_ics` | `vobject` | Generates standards-compliant iCalendar (`.ics`) output |
| `calendar_import_ics` | `vobject` | Parses uploaded `.ics` files |
...
```bash
pip install vobject openupgradelib cssselect
```
